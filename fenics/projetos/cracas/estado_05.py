...
craca1 = msh.Circle(fcs.Point(0.2, 0), 0.24)                          
craca2 = msh.Circle(fcs.Point(0.6, 0), 0.23)                          
craca3 = msh.Circle(fcs.Point(1.0, 0), 0.25)                          
craca4 = msh.Circle(fcs.Point(1.6, 0), 0.24)                          
craca5 = msh.Circle(fcs.Point(1.9, 0), 0.22)                          
craca6 = msh.Circle(fcs.Point(2.3, 0), 0.24)                          
craca7 = msh.Circle(fcs.Point(2.6, 0), 0.23)        
...
### Integração temporal
t = 0  # Tempo inicial
vtkU = fcs.File("sol05/u/u.pvd")
vtkP = fcs.File("sol05/p/p.pvd")
vtkS = fcs.File("sol05/s/s.pvd")
