...
craca1 = msh.Circle(fcs.Point(0.2, 0), 0.14)                          
craca2 = msh.Circle(fcs.Point(0.6, 0), 0.13)                          
craca3 = msh.Circle(fcs.Point(1.0, 0), 0.15)                          
craca4 = msh.Circle(fcs.Point(1.6, 0), 0.14)                          
craca5 = msh.Circle(fcs.Point(1.9, 0), 0.12)                          
craca6 = msh.Circle(fcs.Point(2.3, 0), 0.14)                          
craca7 = msh.Circle(fcs.Point(2.6, 0), 0.13)        
...
### Integração temporal
t = 0  # Tempo inicial
vtkU = fcs.File("sol03/u/u.pvd")
vtkP = fcs.File("sol03/p/p.pvd")
vtkS = fcs.File("sol03/s/s.pvd")
