...
craca1 = msh.Circle(fcs.Point(0.2, 0), 0.08)                          
craca2 = msh.Circle(fcs.Point(0.6, 0), 0.07)                          
craca3 = msh.Circle(fcs.Point(1.0, 0), 0.09)                          
craca4 = msh.Circle(fcs.Point(1.6, 0), 0.08)                          
craca5 = msh.Circle(fcs.Point(1.9, 0), 0.06)                          
craca6 = msh.Circle(fcs.Point(2.3, 0), 0.08)                          
craca7 = msh.Circle(fcs.Point(2.6, 0), 0.07)        
...
### Integração temporal
t = 0  # Tempo inicial
vtkU = fcs.File("sol01/u/u.pvd")
vtkP = fcs.File("sol01/p/p.pvd")
vtkS = fcs.File("sol01/s/s.pvd")
