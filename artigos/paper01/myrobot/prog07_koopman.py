...
for i in tqdm(range(N)):
  ...
  pl.figure(figsize=(5,4), dpi=200)
  pl.plot(X1, X3, 'b.')
  pl.title(str(list(np.round(x0,2))))
  pl.xlabel('$theta_1$')
  pl.ylabel('$omega_1$')
  pl.savefig(DIP+"efases1{:02d}.png".format(i+1))
  pl.clf()
  ...
  pl.xlabel('$theta_2$')
  pl.ylabel('$omega_2$')
  pl.savefig(DIP+"efases2{:02d}.png".format(i+1))
  pl.clf()
  ...
  pl.xlabel('$theta_1$')
  pl.ylabel('$omega_1$')
  pl.savefig(DIP+"koopman1{:02d}.png".format(i+1))
  pl.clf()
  ...
  pl.xlabel('$theta_2$')
  pl.ylabel('$omega_2$')
  pl.savefig(DIP+"koopman2{:02d}.png".format(i+1))
  pl.clf()
