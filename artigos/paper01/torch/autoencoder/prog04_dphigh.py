...
### um pêndulo duplo com alta resolução
...
IMG_DIR = "data/dpendulum/highdef/imgs/"
IMGDIR = "data/dpendulum/highdef/"
...
### Salvando o modelo
torch.save(model.state_dict(),'dphigh.h5')
model1 = Autoencoders()
model1.load_state_dict(torch.load('dphigh.h5'))
model1.eval()
