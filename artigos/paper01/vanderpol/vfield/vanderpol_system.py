### Programa para resolver o sistema do oscilador de Van der Pol
...
def sist_edos(x, tp):
  ...
  x1, x2 = x
  ## Equações diferenciais acopladas -> Pêndulo Complexo
  dx1_dt = x2
  dx2_dt = 8.53*(1-x1*x1)*x2 - x1
  ## Retorno do sistema
...
pl.figure()
plot_campo(vanderpol, xran=[pmin, pmax], yran=[vmin, vmax])
pl.plot(px[0:lp], vx[0:lp], 'r-.')
pl.title("Oscilador de Van der Pol - Pêndulo")
pl.xlabel("Posição (m)")
